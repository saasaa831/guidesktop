...
class ffAttach(BaseTest):
    folderDialog = {'folder_WindowName': 'Open', 'folder_Button': 'Select Folder', 'folder_Edit': 'Folder:'}
    ...
    def folder_attachment(self, value):
        self.cDriver.edit.type_send_keys_gui_action(value, self.fileDialog['folder_WindowName'],
                                                    self.fileDialog['folder_Edit'])

    """Button"""
    def file_attach_open_button(self):
        self.cDriver.button.click_open_button(self.fileDialog['folder_WindowName'], self.fileDialog['file_Button'])

...
class emailWindow(BaseTest):
    ...
    def click_new_email_button(self):
        ...
        self.cDriver.button.click_gui_button_action(self.window_title, self.outLookHome['Newemail_button'])
    ...
    def click_cancel_button_secure_dialog(self):
        self.cDriver.button.click_action_button(elementx=self.accellionSecure_dialog['removeSecure_link'],
                                                wintitle=self.accellionSecure_dialog['SecuredPane_Window'])
    ...
    def click_area_on_focus(self):
        self.cDriver.edit.clickable_action_edit_Points(elementx=self.newEmailWindow['Body_Edit'])
    ...
    def click_new_items_button(self):
        self.cDriver.menuitem.click_gui_menuitem_action(self.window_title, self.outLookHome['Newitems_button'])

    def click_eMessage_menuitem(self):
        self.cDriver.menuitem.click_action_menuitem(elementx=self.newItemsWindow['emailMessage_menuitem'])

    def click_attach_menuitem(self):
        self.cDriver.menuitem.click_action_menuitem(elementx=self.accellionGroup['attach_menuitem'])

    def click_attach_file_menuitem(self):
        self.cDriver.menuitem.click_action_menuitem(elementx=self.accellionGroup['attachfile_menuitem'])

    def click_attach_folder_menuitem(self):
        self.cDriver.menuitem.click_action_menuitem(elementx=self.accellionGroup['attachfolder_menuitem'])

    """Group"""
    def get_acc_group_items(self):
        return self.cDriver.group.get_group_childrens(elementx=self.accellionGroup['accellion_group'])
    ...
    def click_remove_security_link_text(self):
        self.cDriver.text.click_action_text(elementx=self.accellionSecure_dialog['removeSecure_link'],
                                            wintitle=self.accellionSecure_dialog['SecuredPane_Window'])